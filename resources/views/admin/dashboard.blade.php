...
<head>
    <meta charset="utf-8" />
    <title>Champions | Admin & Dashboard</title>
                    ...
                    <li class="dropdown">
                        ...
                        <div class="dropdown-menu">
                            <a class="dropdown-item" href="#"><img
                                    src="{{ asset('assets/admin//images/flags/us_flag.jpg') }}" alt=""
                                    height="15" class="me-2">English</a>
                            <a class="dropdown-item" href="#"><img
                                    src="{{ asset('assets/admin//images/flags/spain_flag.jpg') }}" alt=""
                                    height="15" class="me-2">Spanish</a>
                            <a class="dropdown-item" href="#"><img
                                    src="{{ asset('assets/admin//images/flags/germany_flag.jpg') }}" alt=""
                                    height="15" class="me-2">German</a>
                            <a class="dropdown-item" href="#"><img
                                    src="{{ asset('assets/admin//images/flags/french_flag.jpg') }}" alt=""
                    ...
                    <div class="col-12">
                        <div class="chat-box-left">
                            <ul class="nav nav-tabs nav-justified" id="myTab" role="tablist">
                                ...
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link py-2" id="active_chat_tab" data-bs-toggle="tab"
                                        href="#active_chat" role="tab">Active</a>
                                </li>
                            </ul>
                                                    ...
                                                    <a href="#" class="">
                                                        <div class="d-flex align-items-start">
                                                            <div class="position-relative">
                                                                ...
                                                                <span class="position-absolute bottom-0 end-0"><i
                                                                        class="fa-solid fa-circle text-success fs-10 border-2 border-theme-color"></i></span>
                                                            </div>
                                                            <div
                                                                class="flex-grow-1 ms-2 text-truncate align-self-center">
                                                                <h6 class="my-0 fw-medium text-dark fs-14">Daniel
                                                                    Madsen
                                                                    <small class="float-end text-muted fs-11">5 min
                                                                        age</small>
                                                                </h6>
                                                                <p class="text-muted mb-0"><span
                                                                        class="text-primary">Typing...</span>
                                                                    <span
                                                                        class="badge float-end rounded text-white bg-success ">3</span>
                                                                </p>
                                                            </div><!--end media-body-->
                                                        </div><!--end media-->
                                                    </a> <!--end-->
                                                        ...
                                                        <div class="d-flex align-items-start">
                                                            <div class="position-relative">
                                                                <img src="{{ asset('assets/admin//images/users/avatar-2.jpg') }}"
                                                                    alt="" class="thumb-lg rounded-circle">
                                                                <span class="position-absolute bottom-0 end-0"><i
                                                                        class="fa-solid fa-circle text-secondary fs-10 border-2 border-theme-color"></i></span>
                                                            </div>
                                                            <div
                                                                class="flex-grow-1 ms-2 text-truncate align-self-center">
                                                                <h6 class="my-0 fw-medium text-dark fs-14">James
                                                                    Andrews
                                                                    <small class="float-end text-muted fs-11">30 min
                                                                        ago</small>
                                                                </h6>
                                                                <p class="text-muted mb-0">Amazing Work!! 🔥
                                                                    <span
                                                                        class="badge float-end rounded text-white bg-success ">1</span>
                                                                </p>
                                                            </div><!--end media-body-->
                                                        </div><!--end media-->
                                                    </a> <!--end-->
                                                        ...
                                                        <div class="d-flex align-items-start">
                                                            ...
                                                            <div
                                                                ...
                                                                <h6 class="my-0 fw-medium text-dark fs-14">Shauna Jones
                                                                    <small
                                                                        class="float-end text-muted fs-11">Yesterday</small>
                                                                </h6>
                                                        ...
                                                        <div class="d-flex align-items-start">
                                                            ...
                                                            <div
                                                                ...
                                                                <h6 class="my-0 fw-medium text-dark fs-14">Frank Wei
                                                                    <small class="float-end text-muted fs-11">1
                                                                        Feb</small>
                                                                </h6>
                                                                <p class="text-muted mb-0"><i
                                                                        class="iconoir-microphone"></i> Voice message!
                                                                </p>
                                                            </div><!--end media-body-->
                                                        </div><!--end media-->
                                                    </a> <!--end-->
                                                        ...
                                                        <div class="d-flex align-items-start">
                                                            ...
                                                            <div
                                                                ...
                                                                <h6 class="my-0 fw-medium text-dark fs-14">Karen Savage
                                                                    <small class="float-end text-muted fs-11">8
                                                                        Feb</small>
                                                                </h6>
                                                        ...
                                                        <div class="d-flex align-items-start">
                                                            ...
                                                            <div
                                                                ...
                                                                <h6 class="my-0 fw-medium text-dark fs-14">Carol Maier
                                                                    <small class="float-end text-muted fs-11">12
                                                                        Feb</small>
                                                                </h6>
                                                    ...
                                                    <a href="#" class="">
                                                        <div class="d-flex align-items-start">
                                                            ...
                                                            <div
                                                                class="flex-grow-1 ms-2 text-truncate align-self-center">
                                                                <h6 class="my-0 fw-medium text-dark fs-14">Shauna Jones
                                                                    <small class="float-end text-muted fs-11">15
                                                                        Feb</small>
                                                                </h6>
                                                                <p class="text-muted mb-0">Congratulations!</p>
                                                            </div><!--end media-body-->
                                                    ...
                                                    <a href="#" class="">
                                                        <div class="d-flex align-items-start">
                                                            ...
                                                            <div
                                                                class="flex-grow-1 ms-2 text-truncate align-self-center">
                                                                <h6 class="my-0 fw-medium text-dark fs-14">Frank Wei
                                                                    <small class="float-end text-muted fs-11">2
                                                                        Mar</small>
                                                                </h6>
                                                                <p class="text-muted mb-0"><i
                                                                        class="iconoir-microphone"></i> Voice message!
                                                    ...
                                                    <a href="#" class="">
                                                        <div class="d-flex align-items-start">
                                                            ...
                                                            <div
                                                                class="flex-grow-1 ms-2 text-truncate align-self-center">
                                                                <h6 class="my-0 fw-medium text-dark fs-14">Carol Maier
                                                                    <small class="float-end text-muted fs-11">14
                                                                        Mar</small>
                                                                </h6>
                                                                <p class="text-muted mb-0">Send a pic.!</p>
                                                            </div><!--end media-body-->
                                            ...
                                            <a href="#" class="">
                                                <div class="d-flex align-items-start">
                                                    ...
                                                    <div class="flex-grow-1 ms-2 text-truncate align-self-center">
                                                        ...
                                                        <p class="text-muted mb-0"><i class="iconoir-microphone"></i>
                                                            Voice message!</p>
                                                    </div><!--end media-body-->
                                                </div><!--end media-->
                                            </a> <!--end-->
                            ...
                            <div class="p-3 d-flex justify-content-between card-bg rounded">
                                ...
                                <div class="d-none d-sm-inline-block align-self-center">
                                    <a href="#" class="me-2 text-muted" data-bs-toggle="tooltip"
                                        ...
                                        data-bs-custom-class="tooltip-primary"><i class="iconoir-phone fs-22"></i></a>
                                    <a href="#" class="me-2 text-muted" data-bs-toggle="tooltip"
                                    ...
                                    <a href="#" class="text-muted"><i
                                            class="iconoir-menu-scale fs-22"></i></a>
                                </div>
                            </div><!-- end chat-header -->
                            <div class="chat-body" data-simplebar>
                                <div class="chat-detail">
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <div class="ms-1 chat-box w-100">
                                            <div class="user-chat">
                                                ...
                                                <p class="">Command was run with root privileges. I'm sure about
                                                    that.</p>
                                                <p class="">ok</p>
                                            </div>
                                    ...
                                    <div class="d-flex flex-row-reverse">
                                        ...
                                        <div class="me-1 chat-box w-100 reverse">
                                            <div class="user-chat">
                                                <p class="">Thanks for your message David. I thought I'm alone
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <div class="ms-1 chat-box w-100">
                                            <div class="user-chat">
                                                ...
                                                <p class="">It seems like you are from Mac OS world. There is no
