                ...
                <nav class="topbar-custom d-flex justify-content-between" id="topbar-custom">
                    ...
                    <ul class="topbar-item list-unstyled d-inline-flex align-items-center mb-0">
                        ...
                        <li class="dropdown">
                            ...
                            <img src="{{ asset('assets/admin//images/flags/us_flag.jpg') }}" alt="" class="thumb-sm rounded-circle">
                            </a>
                            <div class="dropdown-menu">
                                <a class="dropdown-item" href="#"><img src="{{ asset('assets/admin//images/flags/us_flag.jpg') }}" alt="" height="15" class="me-2">English</a>
                                <a class="dropdown-item" href="#"><img src="{{ asset('assets/admin//images/flags/spain_flag.jpg') }}" alt="" height="15" class="me-2">Spanish</a>
                                <a class="dropdown-item" href="#"><img src="{{ asset('assets/admin//images/flags/germany_flag.jpg') }}" alt="" height="15" class="me-2">German</a>
                                <a class="dropdown-item" href="#"><img src="{{ asset('assets/admin//images/flags/french_flag.jpg') }}" alt="" height="15" class="me-2">French</a>
                            </div>
                        ...
                        <li class="dropdown topbar-item">
                            <a class="nav-link dropdown-toggle arrow-none nav-icon" data-bs-toggle="dropdown" href="#" role="button"
                                aria-haspopup="false" aria-expanded="false">
                                <img src="{{ asset('assets/admin//images/users/avatar-1.jpg') }}" alt="" class="thumb-lg rounded-circle">
                            </a>
                                                ...
                                                <div class="col">
                                                    ...
                                                    <div class="p-2 border-dashed border-theme-color rounded mb-2">
                                                        <a href="#" class="">
                                                            <div class="d-flex align-items-start">
                                                                <div class="position-relative">
                                                                    <img src="{{ asset('assets/admin//images/users/avatar-2.jpg') }}" alt="" class="thumb-lg rounded-circle">
                                                    ...
                                                    <div class="p-2 border-dashed border-theme-color rounded mb-2">
                                                        <a href="#" class="">
                                                            <div class="d-flex align-items-start">
                                                                <div class="position-relative">
                                                                    <img src="{{ asset('assets/admin//images/users/avatar-3.jpg') }}" alt="" class="thumb-lg rounded-circle">
                                                                    <span class="position-absolute bottom-0 end-0"><i class="fa-solid fa-circle text-secondary fs-10 border-2 border-theme-color"></i></span>
                                                                </div>
                                                                <div class="flex-grow-1 ms-2 text-truncate align-self-center">
                                                    ...
                                                    <div class="p-2 border-dashed border-theme-color rounded mb-2">
                                                        <a href="#" class="">
                                                            <div class="d-flex align-items-start">
                                                                <div class="position-relative">
                                                                    <img src="{{ asset('assets/admin//images/users/avatar-4.jpg') }}" alt="" class="thumb-lg rounded-circle">
                                                                    <span class="position-absolute bottom-0 end-0"><i class="fa-solid fa-circle text-success fs-10 border-2 border-theme-color"></i></span>
                                                                </div>
                                                                <div class="flex-grow-1 ms-2 text-truncate align-self-center">
                                                    ...
                                                    <div class="p-2 border-dashed border-theme-color rounded mb-2">
                                                        <a href="#" class="">
                                                            <div class="d-flex align-items-start">
                                                                <div class="position-relative">
                                                                    <img src="{{ asset('assets/admin//images/users/avatar-5.jpg') }}" alt="" class="thumb-lg rounded-circle">
                                                                    <span class="position-absolute bottom-0 end-0"><i class="fa-solid fa-circle text-secondary fs-10 border-2 border-theme-color"></i></span>
                                                                </div>
                                                                <div class="flex-grow-1 ms-2 text-truncate align-self-center">
                                                    ...
                                                    <div class="p-2 border-dashed border-theme-color rounded mb-2">
                                                        <a href="#" class="">
                                                            <div class="d-flex align-items-start">
                                                                <div class="position-relative">
                                                                    <img src="{{ asset('assets/admin//images/users/avatar-6.jpg') }}" alt="" class="thumb-lg rounded-circle">
                                                                    <span class="position-absolute bottom-0 end-0"><i class="fa-solid fa-circle text-secondary fs-10 border-2 border-theme-color"></i></span>
                                                                </div>
                                                                <div class="flex-grow-1 ms-2 text-truncate align-self-center">
                            ...
                            <div class="chat-box-right">
                                <div class="p-3 d-flex justify-content-between card-bg rounded">
                                    <a href="#" class="d-flex align-self-center">
                                        <div class="flex-shrink-0">
                                            <img src="{{ asset('assets/admin//images/users/avatar-1.jpg') }}" alt="user" class="rounded-circle thumb-lg">
                                        </div><!-- media-left -->
                                ...
                                <div class="chat-body" data-simplebar>
                                    <div class="chat-detail">
                                        <div class="d-flex">
                                            <img src="{{ asset('assets/admin//images/users/avatar-1.jpg') }}" alt="user" class="rounded-circle thumb-md">
                                        ...
                                        <div class="d-flex flex-row-reverse">
                                            <img src="{{ asset('assets/admin//images/users/avatar-3.jpg') }}" alt="user" class="rounded-circle thumb-md">
